...
class ASTERIXPARSER_EXPORT UapEnum
{
public:
...
class ASTERIXPARSER_EXPORT UapField
{
public:
    enum Format {
        INTEGER,
...
class ASTERIXPARSER_EXPORT UapDataItem
{
public:
    UapDataItem() { }
...
class ASTERIXPARSER_EXPORT UapCategory
{
public:
...
class ASTERIXPARSER_EXPORT Uap
{
public:
    ~Uap() { qDeleteAll(m_categories); }
    void readXml(QFile *input);
    void readXml(const QString &dirpath);
